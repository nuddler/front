...
export interface IBillingAccountsView {
    type: string;
}

export interface IBillingAccountsViewState {
    data?: any,
    header: string,
    showMore: boolean;
    list: any[];
...
export class BillingAccountsView extends React.Component<IBillingAccountsView> {

    state: IBillingAccountsViewState = {
        header: "",
        showMore: false,
        list: [],
        moreLinkLabel: ""
